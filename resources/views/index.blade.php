...
<body>
    ...
    <div class="mt-5 text-right">
        <a href="{{ url('dashboard') }}" class="admin-link">Admin</a>
      </div>
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-md-6 text-center mb-5">
                    <h2 class="heading-section"> {{ config('app.name', 'app.name') }}</h2>
                </div>
            </div>
            <div class="row justify-content-center">
                <div class="col-md-12 col-lg-10">
                    <div class="wrap d-md-flex">
                        <div class="img" style="background-image: url({{ url('/frontend/images/well.jpg') }});">
                        </div>
                        <div class="login-wrap p-4 p-md-5">
                            ...
                            <form action="{{ url('simpan-bukutamu') }}" method="POST" class="signin-form">
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <input type="kategori" name="kategori" class="form-control"
                                        placeholder="Silahkan Pilih" required>
                                </div>
                                <div class="form-group mb-3">
                                    <label class="label" for="alamat">Keperluan</label>
                                    <textarea name="keperluan" class="form-control" placeholder="Silahkan Isi Keperluan Anda" cols="3"></textarea>
                                </div>
                                <div class="form-group">
                                    <button type="submit" onclick="return confirm('Apakah Data Anda Sudah Benar?');"
