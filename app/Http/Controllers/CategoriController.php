...
class CategoriController extends Controller
{
    ...
    {
        $data = Categori::latest()->paginate(5);

        return view('admin.categori.index', compact('data'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('categoris.index')->with('success', 'Kategori berhasil di tambahkan');
    }
